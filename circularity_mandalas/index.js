...
//qcomplexity=3;
var spreadl = (150/qcomplexity); console.log(spreadl);

var qorientation ="portrait";
var qframecolor = R.random_int(0,3) < 1 ? "White" : R.random_int(1,3) < 2 ? "Mocha" : "Random";
var qoriginx = R.random_int(400,400);
var qoriginy = R.random_int(400,400);
var qlinethickness = 6;console.log(qlinethickness)
var qmatwidth = R.random_int(50,100);
qmatwidth = 50;
var qaspectratio = "circle";
...
for (cx = 1;cx<qcomplexity+1;cx++){
    r=cx;sa = ~~(R.random_dec()*shapes.length);d=~~(noise.get(r)*1);ro=~~(noise.get(r)*5);sx=~~(noise.get(r)*5);sy=~~(noise.get(r)*5);rs=~~(ringlets+noise.get(r)*ringlets*3);
...
r=1;sa = ~~(R.random_dec()*shapes.length);d=~~(noise.get(r)*1);ro=~~(noise.get(r)*5);sx=~~(noise.get(r)*5);sy=~~(noise.get(r)*5);rs=~~(ringlets+noise.get(r)*ringlets);
fc = ~~(rings[r-1].fromCenter+rings[r-1].ringSize-(R.random_dec()*ringlets));s=segs[~~(R.random_dec()*segs.length)];
rings[r]={"shape":sa,"center":center,"fromCenter":fc,"ringSize":rs,"segments":s,"delete":1,"rotation":ro,"skewx":sx,"skewy":sy}

r=2;sa = ~~(R.random_dec()*shapes.length);d=~~(noise.get(r)*1);ro=~~(noise.get(r)*5);sx=~~(noise.get(r)*5);sy=~~(noise.get(r)*5);rs=~~(ringlets+noise.get(r)*ringlets);
fc = ~~(rings[r-1].fromCenter+rings[r-1].ringSize-(R.random_dec()*ringlets));s=segs[~~(R.random_dec()*segs.length)];
rings[r]={"shape":sa,"center":center,"fromCenter":fc,"ringSize":rs,"segments":s,"delete":1,"rotation":ro,"skewx":sx,"skewy":sy}

r=3;sa = ~~(R.random_dec()*shapes.length);d=~~(noise.get(r)*1);ro=~~(noise.get(r)*5);sx=~~(noise.get(r)*5);sy=~~(noise.get(r)*5);rs=~~(ringlets+noise.get(r)*ringlets);
fc = ~~(rings[r-1].fromCenter+rings[r-1].ringSize-(R.random_dec()*ringlets));s=segs[~~(R.random_dec()*segs.length)];
rings[r]={"shape":sa,"center":center,"fromCenter":fc,"ringSize":rs,"segments":s,"delete":1,"rotation":ro,"skewx":sx,"skewy":sy}

r=4;sa = ~~(R.random_dec()*shapes.length);d=~~(noise.get(r)*1);ro=~~(noise.get(r)*5);sx=~~(noise.get(r)*5);sy=~~(noise.get(r)*5);rs=~~(ringlets+noise.get(r)*ringlets);
fc = ~~(rings[r-1].fromCenter+rings[r-1].ringSize-(R.random_dec()*ringlets));s=segs[~~(R.random_dec()*segs.length)];
rings[r]={"shape":sa,"center":center,"fromCenter":fc,"ringSize":rs,"segments":s,"delete":1,"rotation":ro,"skewx":sx,"skewy":sy}

r=5;sa = ~~(R.random_dec()*shapes.length);d=~~(noise.get(r)*1);ro=~~(noise.get(r)*5);sx=~~(noise.get(r)*5);sy=~~(noise.get(r)*5);rs=~~(ringlets+noise.get(r)*ringlets);
fc = ~~(rings[r-1].fromCenter+rings[r-1].ringSize-(R.random_dec()*ringlets)); rs=os-fc;s=segs[~~(R.random_dec()*segs.length)];
rings[r]={"shape":sa,"center":center,"fromCenter":fc,"ringSize":rs,"segments":s,"delete":1,"rotation":ro,"skewx":sx,"skewy":sy}

r=6;sa = ~~(R.random_dec()*shapes.length);d=~~(noise.get(r)*1);ro=~~(noise.get(r)*5);sx=~~(noise.get(r)*5);sy=~~(noise.get(r)*5);rs=~~(ringlets+noise.get(r)*ringlets);
fc = ~~(rings[r-1].fromCenter+rings[r-1].ringSize-(R.random_dec()*ringlets)); rs=os-fc;s=segs[~~(R.random_dec()*segs.length)];
rings[r]={"shape":sa,"center":center,"fromCenter":fc,"ringSize":rs,"segments":s,"delete":1,"rotation":ro,"skewx":sx,"skewy":sy}

r=7;sa = ~~(R.random_dec()*shapes.length);d=~~(noise.get(r)*1);ro=~~(noise.get(r)*5);sx=~~(noise.get(r)*5);sy=~~(noise.get(r)*5);rs=~~(ringlets+noise.get(r)*ringlets);
fc = ~~(rings[r-1].fromCenter+rings[r-1].ringSize-(R.random_dec()*ringlets)); rs=os-fc;s=segs[~~(R.random_dec()*segs.length)];
rings[r]={"shape":sa,"center":center,"fromCenter":fc,"ringSize":rs,"segments":s,"delete":1,"rotation":ro,"skewx":sx,"skewy":sy}

r=8;sa = ~~(R.random_dec()*shapes.length);d=~~(noise.get(r)*1);ro=~~(noise.get(r)*5);sx=~~(noise.get(r)*5);sy=~~(noise.get(r)*5);rs=~~(ringlets+noise.get(r)*ringlets);
fc = ~~(rings[r-1].fromCenter+rings[r-1].ringSize-(R.random_dec()*ringlets)); rs=os-fc;s=segs[~~(R.random_dec()*segs.length)];
rings[r]={"shape":sa,"center":center,"fromCenter":fc,"ringSize":rs,"segments":s,"delete":1,"rotation":ro,"skewx":sx,"skewy":sy}

r=9;sa = ~~(R.random_dec()*shapes.length);d=~~(noise.get(r)*1);ro=~~(noise.get(r)*5);sx=~~(noise.get(r)*5);sy=~~(noise.get(r)*5);rs=~~(ringlets+noise.get(r)*ringlets);
fc = ~~(rings[r-1].fromCenter+rings[r-1].ringSize-(R.random_dec()*ringlets)); rs=os-fc;s=segs[~~(R.random_dec()*segs.length)];
rings[r]={"shape":sa,"center":center,"fromCenter":fc,"ringSize":rs,"segments":s,"delete":1,"rotation":ro,"skewx":sx,"skewy":sy}

r=10;sa = ~~(R.random_dec()*shapes.length);d=~~(noise.get(r)*1);ro=~~(noise.get(r)*5);sx=~~(noise.get(r)*5);sy=~~(noise.get(r)*5);rs=~~(ringlets+noise.get(r)*ringlets);
fc = ~~(rings[r-1].fromCenter+rings[r-1].ringSize-(R.random_dec()*ringlets)); rs=os-fc;s=segs[~~(R.random_dec()*segs.length)];
rings[r]={"shape":sa,"center":center,"fromCenter":fc,"ringSize":rs,"segments":s,"delete":1,"rotation":ro,"skewx":sx,"skewy":sy}
*/
...
function signature(z){
    ...
    shawn.strokeWidth = 1;
    shawn.scale(ratio*.9)
    shawn.position = new Point(wide/2, high-framewidth+~~(shawn.bounds.height));
    cut(z,shawn)
}
